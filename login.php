...
<html lang='en'>
  ...
  if ($conn->connect_error) {
   ...
   if(isset($_POST['email'])){
    ...
    $sql = "SELECT * FROM registration WHERE emailId='".$email."' AND password='".$password."' LIMIT 1";

    $result = mysqli_query($conn, $sql);

    if(mysqli_num_rows($result)==1){
        echo "<h1>"."You have successfully Logged in!!"."</h1>";
        echo '<h3><a href="home.php" style="color:red;">'."Go to the Home page!!!"."</a></h3>";
        exit();
    }
    else{
        echo "<h1>"."You have entered Incorrect Details!!"."</h1>";
        echo '<h3><a href="login.php" style="color:red;">'."Go to the Login page!!!"."</a></h3>";
        exit();
    }
   }
  ...
  <!--script src="login.js"></script-->
    <form class="box" method='POST' id="form" action="#">
      ...
      <h1 style="color: black;text-align: center;font-family: 'Bad Script', cursive;font-size:22px">LOGIN</h1>
